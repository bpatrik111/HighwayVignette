...
object CountyAdjacency {
    ...
    private val adjacency: Map<String, Set<String>> = mapOf(
        ...
        "YEAR_16" to setOf("YEAR_21", "YEAR_28", "YEAR_26", "YEAR_11", "YEAR_23"), // Fejér
        ...
        "YEAR_24" to setOf("YEAR_27", "YEAR_28", "YEAR_26", "YEAR_12"), // Somogy
        "YEAR_25" to setOf("YEAR_14", "YEAR_18"), // Szabolcs-Szatmár-Bereg
        "YEAR_26" to setOf("YEAR_24", "YEAR_12", "YEAR_11", "YEAR_16"), // Tolna
        "YEAR_27" to setOf("YEAR_17", "YEAR_28", "YEAR_24"), // Vas
        "YEAR_28" to setOf("YEAR_17", "YEAR_27", "YEAR_24", "YEAR_26", "YEAR_16", "YEAR_21"), // Veszprém
